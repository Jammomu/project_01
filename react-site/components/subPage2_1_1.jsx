          ...
          <div className="main-nav" style={{zIndex: 1}}>
            <ul className="main-nav-index">
              ...
              <ul style={{margin: 0, padding: 0}}>
                ...
                <li className="main-nav-box"><a id="this-page" href="./productPage.html" style={{color: '#676ba7'}}>서비스소개 스타일1</a></li>
                <li className="main-nav-box"><a href="./productPage_1_2.html">서비스소개 스타일2</a></li>
